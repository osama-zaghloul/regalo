...
<div class="box box-primary">
              ...
              {{ Form::open(array('method' => 'POST','files' => true,'url' =>'adminpanel/provider' )) }}
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="password" id="confirmadminpass1" class="form-control" required name="repass" >
...
اح
    ...
    <div class="box-footer">
        <button type="submit" id="submit1" class="btn btn-primary col-md-offset-4 col-md-4" >اضافة</button>
    </div>
    {!! Form::close() !!}
       </div>
</div> 
