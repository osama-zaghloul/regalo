...
<body class="hold-transition skin-blue sidebar-mini sidebar-open">
 ...
 <header class="main-header" style="color:green">
    ...
    <ul class="sidebar-menu">
        ...
        @endif
          ...
          @endif
            ...
            <ul class="treeview-menu">
              <li  @if($subactive=='category') class="active" @endif><a href="{{asset('adminpanel/categories')}}"><i class="fa fa-circle-o"></i>كل الأقسام </a></li>
